        ...
        <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full max-w-full flex-grow flex-1">
              ...
              <h2 className="text-blueGray-700 text-l font-bold">Suresh</h2>
              <h3 className="text-blueGray-700 fs-5 font-semibold">Driver</h3>
              <p> </p>
              <h3 className="text-blueGray-700 fs-6 font-semibold">Ambulance Driver for Kukatpally area</h3>
            </div>
